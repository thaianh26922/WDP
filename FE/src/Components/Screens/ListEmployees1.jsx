                                        ...
                                        items.push(
                                            <tr class="bg-white border-b border-gray-200">
                                                <th scope="row" class="px-3 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    Dragon Ocean tuyển dụng vị trí giám đốc chi nhánh Hà Nội
                                                </th>
                                                <td class="px-3 py-4">
                                                    20.000.000vnd
                                                </td>
                                                ...
                                                <td class="px-3 py-4 flex gap-x-3 justify-center">
